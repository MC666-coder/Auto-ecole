...
<body>
    <div class="nav-contain">
        <div class="liens">
            ...
            <a href="../html/mes_eleves.php">mes_eleves_acceptés</a>
    ...
    <div class="profil">
        <?php
            ...
            $dmd=$conn->prepare("SELECT 
                                ...
                                LEFT JOIN 
                                    ville AS ville_moniteur ON moniteur.id_ville = ville_moniteur.id_ville; 
                                ");
            $dmd->execute();
            ...
            foreach($liste as $row){
                echo "<div><ul class='bulles'>";
                    ...
                    echo "<li>status de la demande:".$row['status']."</li>";
                        ...
                        echo"<form action='refuser.php' method='POST'>
                            <input type='hidden' name='id_demande' value='".$row['id_demande']."'>
